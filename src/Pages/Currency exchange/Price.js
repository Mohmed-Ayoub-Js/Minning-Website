    ...
    <div>
      ...
      <FormControl sx={{ m: 1 }} variant="standard">
        ...
        >
          ...
          <MenuItem value={10}>Bitcion</MenuItem>
          <MenuItem value={20}>Dash</MenuItem>
          <MenuItem value={30}>TRX</MenuItem>
        </Select>
      </FormControl>
      <FormControl sx={{ m: 1 }} variant="standard">
        <InputLabel htmlFor="demo-customized-select-native">To</InputLabel>
        <NativeSelect
        ...
        >
          ...
          <option value={10}>TRON</option>
          <option value={20}>DOGE</option>
          <option value={30}>LTC</option>
        </NativeSelect>
        <center>
        <ButtonApplicationFromGlobal title='get'/>
        </center>
      </FormControl>
    </div>
  );
